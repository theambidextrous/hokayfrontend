...
import ServiceBox from "./jt-service-box";
import { findByTag, searchJobs } from "../../api/api";
...
class Services extends Component {
  ...
  handlePageClick = (data) => {
    ...
    this.setState({ ...this.state, offset:offset,preload:true }, () => {
      findByTag(this.state.current, this.state.offset)
    ...
    return (
      <React.Fragment>
        ...
        <Helmet>
            ...
            <link rel="canonical" href={process.env.REACT_APP_DOMAIN + '/jobs/tag/' + this.state.current} />
        </Helmet>
        {/* SERVICE START  */}
